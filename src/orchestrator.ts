      ...
      files: [
        {
          ...
          filename: `surveillance_${tipId.slice(0, 6)}.mp4`,
          media_type: "video",
          file_size_bytes: 1024 * 1024 * 5,
          esp_viewed: false,
          esp_viewed_missing: false,
          publicly_available: false,
          warrant_required: tier === "IMMEDIATE" || tier === "URGENT",
          file_access_blocked: tier === "IMMEDIATE" || tier === "URGENT",
          warrant_status: (tier === "IMMEDIATE" || tier === "URGENT") ? "applied" : "not_needed",
        ...
        {
          file_id: crypto.randomUUID(),
          filename: `metadata_${tipId.slice(0, 6)}.json`,
          media_type: "document",
