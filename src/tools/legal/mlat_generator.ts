...
export const TREATY_DATABASE: Record<string, CountryTreatyProfile> = {
  ...
  CO: {
    ...
    has_mlat: true, mlat_treaty_name: "Treaty on Mutual Legal Assistance in Criminal Matters (US-Colombia)", mlat_year: 1982,
    has_cloud_act: false,
    budapest_party: true,
    oai_contact: "DOJ OIA — Latin America Desk",
    ncb_city: "Bogotá",
    estimated_response: "MLAT: 6–12 months",
    language_required: "Spanish",
    notes: "PNC (National Police of Colombia) handles cyber crimes. Budapest Convention signatory. Good cooperation on ICAC cases.",
  },
  ID: {
    ...
    oai_contact: "DOJ OIA — Asia-Pacific Desk",
    ncb_city: "Jakarta",
    estimated_response: "Letters rogatory: 12–24 months",
    language_required: "Indonesian",
    notes: "No MLAT. FBI Jakarta Legat typically coordinates urgent child exploitation cases with Indonesian National Police (INP).",
  },
  TH: {
    country_code: "TH", country_name: "Thailand",
    has_mlat: true, mlat_treaty_name: "Treaty on Mutual Legal Assistance in Criminal Matters (US-Thailand)", mlat_year: 1993,
    has_cloud_act: false,
    budapest_party: false,
    oai_contact: "DOJ OIA — Asia-Pacific Desk",
    ncb_city: "Bangkok",
    estimated_response: "MLAT: 6–12 months",
    language_required: "Thai",
    notes: "Royal Thai Police (RTP) handles requests. US agencies often leverage local attaché for parallel coordination.",
  },
  VN: {
    ...
    ncb_city: "Hanoi",
    estimated_response: "Letters rogatory: 12–24 months",
    language_required: "Vietnamese",
    notes: "No MLAT. Letters rogatory required. Very complex to acquire direct production without domestic law enforcement coordination via Legat.",
  },
  RO: {
